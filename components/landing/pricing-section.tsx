...
const plans = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "Access 8 dashboards instantly. No credit card, no trial expiration.",
    cta: "Create free account",
    ctaVariant: "outline" as const,
    highlights: [
      { text: "NRFI, Weather & First Basket (no account needed)", included: true },
      { text: "Defense vs Position (NBA + NFL)", included: true },
      { text: "All 3 Trends dashboards (MLB, NBA, NFL)", included: true },
      { text: "Head-to-Head, Hot Hitters & Pitching Stats", included: false },
  ...
  },
  {
    ...
    cta: "Unlock all 12 dashboards",
    ctaVariant: "default" as const,
    popular: true,
    highlights: [
      { text: "Everything in Free", included: true },
      { text: "Head-to-Head matchup history", included: true },
      { text: "Hot Hitters, Hitting & Pitching Stats", included: true },
      { text: "NFL Matchup", included: true },
      { text: "All 12 dashboards across MLB, NBA, NFL", included: true },
