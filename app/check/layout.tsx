...
export const metadata = generateSEO({
  ...
  description: "Analyze any player's props with our 7-factor convergence engine. See all prop lines, hit rates, and verdicts for MLB, NBA & NFL players at a glance.",
  path: "/check",
