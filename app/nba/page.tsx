    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] sm:text-xs text-muted-foreground">NBA Dashboards</p>
              </div>
            </Link>
          </div>
      ...
      <main className="mx-auto max-w-[1440px] px-4 sm:px-6 py-6 sm:py-10">
        <div className="mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-foreground">NBA Dashboards</h2>
