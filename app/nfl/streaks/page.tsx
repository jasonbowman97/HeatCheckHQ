...
export default function NFLStreaksPage() {
  const { data, isLoading, error, mutate } = useSWR<{
    players: EnrichedPlayer[]
    updatedAt: string
  }>("/api/nfl/streaks", fetcher, {
        ...
        {error ? (
          <div className="flex flex-col items-center justify-center py-24 gap-3">
            ...
            <p className="text-xs text-muted-foreground">
              Something went wrong fetching NFL player stats. Try again.
            </p>
            <button
              onClick={() => mutate()}
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-3">
            ...
            <p className="text-sm text-muted-foreground">
              Loading player game logs for top NFL QBs, RBs, and WRs...
            </p>
          </div>
        ) : (
          <>
